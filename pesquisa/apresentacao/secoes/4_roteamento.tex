...
\begin{frame}{Estrela}
    A estrela é a mais simples, onde cada nó transmite diretamente para um gateway ou receptor. Essa topologia, entretanto, é limitada pela distância, visto que os nós precisam estar no alcance do \textit{gateway} (GTA/UFRJ, 2018).
\end{frame}
...
\begin{frame}{Roteamento Hierárquico (Continuação)}
    ...
    Neste protocolo, os líderes não são fixos. Na fase de inicialização, cada nó transmite sua energia disponível e sua localização para a estação-base, na qual irá definir os \textit{clusters} e o nó líder, que é escolhido dentre os nós com maior energia restante  (GTA/UFRJ, 2018).
\end{frame}
